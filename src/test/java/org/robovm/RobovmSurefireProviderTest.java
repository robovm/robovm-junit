...
import org.robovm.surefire.RobovmSurefireProvider;
...
import org.robovm.surefire.internal.ThrowableTypeAdapter;
...
public class RobovmSurefireProviderTest {
    ...
    public void testResultObjectSerialization() {
        ...
        resultObject.setFailure(new Failure(Description.createSuiteDescription("test"),new RuntimeException("error")));
    ...
    public void testResultObjectDeserialization() {
        ...
        assertTrue(deserializedResultObject.getDescription().getChildren().get(0).getDisplayName().equals("com.example.TestTest"));
