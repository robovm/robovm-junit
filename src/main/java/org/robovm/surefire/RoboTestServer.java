...
public class RoboTestServer extends org.junit.runner.notification.RunListener {
    ...
    private ReportEntry createReportEntry(Failure failure) {
        ...
        return SimpleReportEntry.withException(getClassName(description),
               ...
               new LegacyPojoStackTraceWriter(getClassName(description), description.getDisplayName(), failure.getException()));
                ...
                .subscribe(new Action1<String>() {
                    ...
                    public void call(String jsonString) {
                        ...
                        switch (resultObject.getResultType()) {
                            ...
                            case TEST_STARTED:
                                try {
                                    Logger.log("Test " + resultObject.getDescription().getDisplayName() + " started");
                                    testStarted(resultObject.getDescription());
                                    reporter.testStarting(createReportEntry(resultObject.getDescription()));
                                } catch (Exception e) {
                                    e.printStackTrace();
                                }
                                break;
                            ...
                            case TEST_RUN_FINISHED:
                                try {
                                    ...
                                    reporter.testSetCompleted(new SimpleReportEntry("done", "done"));
                    ...
                    public void call(Throwable throwable) {
                        System.err.println("Error receiving result from simulator " + throwable.getMessage());
                    }
                }, new Action0() {
                    @Override
                    public void call() {
