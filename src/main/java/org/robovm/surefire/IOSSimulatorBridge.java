...
public class IOSSimulatorBridge {
    ...
    private void compileAndRunTest() throws IOException {
        ...
        configBuilder.addClasspathEntry(new File(mavenRepositoryDir + "/repository/org/apache/maven/surefire/surefire-junit4/2.12.4/surefire-junit4-2.12.4.jar"));
        configBuilder.addClasspathEntry(new File("/Users/ash/Downloads/robovm-0.0.14/lib/robovm-compiler.jar"));
        configBuilder.addClasspathEntry(new File(mavenRepositoryDir + "/repository/com/google/code/gson/gson/2.2.4/gson-2.2.4.jar"));
        configBuilder.addClasspathEntry(new File(mavenRepositoryDir + "/repository/junit/junit/4.8.2/junit-4.8.2.jar"));
        configBuilder.addClasspathEntry(new File(mavenRepositoryDir + "/repository/org/robovm/robovm-surefire-provider/1.0/robovm-surefire-provider-1.0.jar"));
        configBuilder.addClasspathEntry(new File(mavenRepositoryDir + "/repository/org/apache/maven/surefire/surefire-api/2.17/surefire-api-2.17.jar"));
        configBuilder.addClasspathEntry(new File(mavenRepositoryDir + "/repository/biz/source_code/base64coder/2010-12-19/base64coder-2010-12-19.jar"));
